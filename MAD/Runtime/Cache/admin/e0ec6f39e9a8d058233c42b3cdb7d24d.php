...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">视频管理</strong> / <small>MAD</small></div>
    </div>
          ...
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              ...
              <!-- <th class="table-check"><input type="checkbox" /></th> -->
                <th class="table-id">ID</th><th class="table-title">标题</th><th class="table-author">作者</th><th class="table-date">上传日期</th><th class="table-date">状态</th><th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
            ...
            <?php if(is_array($videoList)): foreach($videoList as $key=>$video): ?><tr>
              ...
              <td>MAD<?php echo ($video["id"]); ?></td>
              <td><a href="__URL__/checkVideo?vid=MAD<?php echo ($video["id"]); ?>"><?php echo ($video["title"]); ?></a></td>
              <td><?php echo ($video["zuozhe"]); ?></td>
              <td><?php echo ($video["update_time"]); ?></td>
              <td><?php echo ($video["state_name"]); ?></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <a href="__URL__/check?id=<?php echo ($video["id"]); ?>&type=1" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>审核</a>
                    <!-- <a  href="__URL__/check?id=<?php echo ($video["id"]); ?>&type=2" class="am-btn am-btn-default am-btn-xs am-text-danger"><span class="am-icon-trash-o"></span> 封禁</a> -->
