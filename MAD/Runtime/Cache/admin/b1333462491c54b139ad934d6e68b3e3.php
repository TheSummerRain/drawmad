...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页推荐</strong> / <small>Home</small></div>
    </div>
        ...
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            <div class="am-btn-group am-btn-group-xs">
              <a href="__URL__/addHomePage" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
      ...
      <div class="am-u-sm-12">
        ...
        <form class="am-form" method="POST" action="__URL__/purview"> 
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-id">ID</th><th class="table-author">链接</th><th class="table-date">简述</th><th class="table-date">操作</th>
              </tr>
          </thead>
          <tbody>

            <?php if(is_array($homePageList)): foreach($homePageList as $key=>$home): ?><tr> 
              <td>HM<?php echo ($home["id"]); ?></td>
              <td><a href="<?php echo ($home["url"]); ?>" target="_blank"><?php echo ($home["url"]); ?></a>
              <td><?php echo ($home["explain"]); ?></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                  
                  <a href="__URL__/addHomePage?id=<?php echo ($home["id"]); ?>" class="am-btn am-btn-default am-btn-xs"><span class="am-icon-pencil-square-o"></span>修改</a>

                  <a href="__URL__/delHomePage?id=<?php echo ($home["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-danger"><span class="am-icon-pencil-square-o"></span>删除</a>
