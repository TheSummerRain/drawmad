      ...
      <div class="am-tab-panel am-fade am-in am-active" id="tab1">
        ...
        <div class="am-u-sm-12">
          <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <?php if(is_array($roleGroupList)): foreach($roleGroupList as $key=>$user): ?><tr>
                <td>PID<?php echo ($user["id"]); ?></td>
                <td><a href="#"><?php echo ($user["name"]); ?></a></td>
                <td><?php echo (date('Y年m月d日 H:i:s', $user["create_time"])); ?></td>
                <td>
                <input type="hidden" name="roidGroupIdsV" value="<?php echo ($user["role_id"]); ?>" >
        ...
        <form class="am-form" method="POST" action="__URL__/update">
          ...
          <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-4 current_purview_id" style="display:inline-block">
              <?php if(is_array($roleList)): foreach($roleList as $key=>$role): ?><div style="display:inline-block">
                  <input type="checkbox" id="PPID<?php echo ($role["id"]); ?>" value="<?php echo ($role["id"]); ?>" name="role[]" class="type_checkbox" >
                  <label class="check" style=" font-weight:normal"><?php echo ($role["role"]); ?></label>
