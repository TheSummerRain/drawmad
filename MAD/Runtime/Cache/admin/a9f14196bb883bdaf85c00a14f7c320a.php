...
<div class="am-tabs am-margin" data-am-tabs>
  <ul class="am-nav am-nav-tabs"><!-- am-tabs-nav  -->
      <li id="tabli1"><a href="__APP__/Admin/XRZVideo">视频发布</a></li>
      <li id="tabli2" class="am-active"><a href="#">参赛人管理</a></li>
          ...
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              ...
              <!-- <th class="table-check"><input type="checkbox" /></th> -->
                <th class="table-id">UID</th><th class="table-title">昵称</th><th class="table-author">视频标题</th><th class="table-author">视频状态</th><th class="table-author">所属组</th><th class="table-author">操作</th>
              </tr>
          </thead>
          <tbody>
            
            <?php if(is_array($gameMadList)): foreach($gameMadList as $key=>$gameMad): ?><tr>
              <td>UID<?php echo ($gameMad["user_id"]); ?></td>
              <td><a href="__APP__/MyZone?userid=<?php echo ($gameMad["user_id"]); ?>"><?php echo ($gameMad["nicheng"]); ?></a></td>
              <td><a href="__APP__/VideoDetail?vid=MAD<?php echo ($gameMad["video_id"]); ?>"><?php echo ($gameMad["title"]); ?></a></td>
              <td><?php echo ($gameMad["state_name"]); ?></td>
              <td><?php echo ($gameMad["group_name"]); ?></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                     
                    <a href="__URL__/modifyGroup?id=<?php echo ($gameMad["game_mad_user_id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-danger"><span class="am-icon-trash-o"></span> 修改组别</a>
                  </div>
                </div>
              </td>
