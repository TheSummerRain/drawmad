...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">通知模版</strong> / <small>modelNotice</small></div>
    </div>
  
<div class="am-tabs am-margin" data-am-tabs>
    <ul class="am-nav am-nav-tabs">
      <li id="tabli1"><a href="__APP__/Game/Notice">系统通知</a></li>
      <li id="tabli2"><a href="__APP__/Game/Notice/locateNotice">定向通知</a></li>
      <li id="tabli3" class="am-active"><a href="">通知模版</a></li>
    </ul>
        ...
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            <div class="am-btn-group am-btn-group-xs">
              <a href="__URL__/addModelNotice" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
          ...
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              ...
              <!-- <th class="table-check"><input type="checkbox" /></th> -->
                <th class="table-id">ID</th><th class="table-title">通知名称</th><th class="table-author">通知内容</th>
              </tr>
          </thead>
          <tbody>
            ...
            <?php if(is_array($noticeList)): foreach($noticeList as $key=>$notice): ?><tr>
              ...
              <td><a href="#"><?php echo ($notice["name"]); ?></a></td>
              <td><?php echo ($notice["content"]); ?></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                     <a href="__URL__/delModelNotice?id=<?php echo ($notice["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>删除</a>
                    <a href="__URL__/addModelNotice?id=<?php echo ($notice["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-danger"><span class="am-icon-trash-o"></span> 修改</a>
                  </div>
                </div>
              </td>
